...
import { loginUser } from '../../config/Appwrite/api'
          ...
          <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
            ...
            {toast &&
              <div id="toast-interactive" class="w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:bg-gray-800 dark:text-gray-400" role="alert">
                <div className="flex">
                  <div className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-red-500 bg-blue-100 rounded-lg dark:text-blue-300 dark:bg-blue-900">
                  ...
                  <div className="ms-3 text-sm font-normal">
                    <span className="mb-1 text-sm font-semibold text-gray-900 dark:text-white">Something Went Wrong ? </span>
                ...
                <div>
                  {
                    loading ? (
                      ...
                      >
                        <div role="status">
                          <svg aria-hidden="true" class="w-8 h-8 text-gray-200 animate-spin dark:text-white-600 fill-gray-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
